...
exports.pullRemote = function(){
    ...
    return new Promise((resolve, reject) => {
        const distroURL = 'https://adderiy.com/api/distribution.json'
...
exports.setDevMode = function(value){
    if(value){
        logger.log('Режим разработчика включен.')
        logger.log('Если вы не знаете, что это значит, немедленно вернитесь.')
    } else {
        logger.log('Режим разработчика отключен.')
    }
    DEV_MODE = value
}
